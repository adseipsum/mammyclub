 ...
 * @property Doctrine_Collection $supplier_request
 * 
 * @package    ##PACKAGE##
 ...
 */
abstract class BaseSupplierRequestStatus extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('supplier_request_status');
    ...
    public function setUp()
    {
        ...
        $this->hasMany('SupplierRequest as supplier_request', array(
             'local' => 'id',
             'foreign' => 'supplier_request_status_id'));
    }
}