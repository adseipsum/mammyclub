<h2>Обновить остатки "Нормативный склад"</h2>
<form action="<?=pager_remove_from_str(current_url()) . '/process_file_standard_store';?>" method="post" class="form validate" autocomplete="off" enctype="multipart/form-data">
	...
	<div class="group">
		...
		<p>
			Тип файла: Excel<br>
			Лист: TDSheet<br>
			Идентификация по штрих-коду в колонке: B<br>
			Колонка со значением: C<br>
		</p>
	</div>
