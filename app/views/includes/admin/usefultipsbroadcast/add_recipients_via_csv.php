<div class="content default-box">
  ...
  <h2 class="title">
    ...
    <a class="link" style="float: right;" href="<?=admin_site_url('usefultipsbroadcast')?>"><?=lang('admin.add_edit_back');?></a>
    <div class="clear"></div>
  </h2>
  <?=html_flash_message();?>
  ...
  <div class="search-box filter-bar">
    ...
    <form action="<?=admin_site_url('usefultipsbroadcast/add_recipients_via_csv_process')?>" enctype="multipart/form-data" method="post" class="validate">
