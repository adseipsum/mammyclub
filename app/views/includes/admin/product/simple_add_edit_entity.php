  ...
  <div class="inner">
    <form action="<?=site_url($processLink) . get_get_params();?>" method="post" class="form validate" id="editForm" autocomplete="off" enctype="multipart/form-data">
      <div class="group navform wat-cf">
        ...
        <? endif;?>
        <button class="button" type="submit" name="save_and_update_revision_date" value="1">
          <img src="<?=site_img("admin/icons/tick.png")?>" alt="<?=lang('admin.save_and_update_revision_date');?>"/><?=lang('admin.save_and_update_revision_date');?>
        </button>
