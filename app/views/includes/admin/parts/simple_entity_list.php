  ...
  <?if (isset($entities) && sizeof($entities) > 0):?>
    ...
    <? endif; ?>
      ...
      <table id="list_<?=$entityName;?>" class="table">
            ...
            <?foreach($params as $param):?>
              ...
              <? if(is_array($param)): ?>
                ...
                <? else: ?>
                  ...
                  <? else: ?>
                    <td><?if(isset($link)):?><a href="<?=$link;?>"><?endif;?><?=truncate(strip_tags(trim($viewVal)), 100, '...');?><?if(isset($link)):?></a><?endif;?></td>
                  <? endif; ?>
                <? endif; ?>
              <? else: ?>
              	<? if (isset($el[$param])): ?>
        ...
        <tfoot>
          <tr>
            <td class="vm" colspan="<?=++$colSpan-1?>"><?=lang("admin.total")?>: <?=$totalCount;?></td>
            <td>
