<? $supplierRequest = reset($supplierRequests) ?>

<div class="title">
  Лог изменения статуса заявки поставщику <?=$supplierRequest?>
</div>
<?=html_flash_message();?>
<div class="inner">
  ...
  <table class="table">
    ...
    <? foreach ($eventLogs as $v) : ?>
      <tr>
<!--        <td><a href="--><?//=admin_site_url('supplierrequest/add_edit/' . $v['entity_id'])?><!--" target="_blank">--><?//=$supplierRequests[$v['entity_id']]?><!--</a></td>-->
        <td>
