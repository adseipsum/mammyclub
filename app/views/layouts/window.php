...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <head>
    ...
    <script type="text/javascript" src="<?=site_js("admin/jquery/jquery.min.js,
                                                    ...
                                                    admin/jquery/ui/draggable.js,
                                                    admin/jquery/ui/dialog.js,
                                                  	admin/jquery/bgiframe.min.js,
                                                    admin/jquery/alerts.js,
                                                    admin/window.core.js,
                                                    admin/confirm.js");?>"></script>
