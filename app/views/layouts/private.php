...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xml:lang="en" >
  <head>
    ...
    <? $css = "common/zero.css, common/messages.css, common/ajax-popup2.css, html-content.css, buttons.css, ezmark.css, style.css, admin/base/jquery-ui-all.css"; ?>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        var registerPopupHidden = $.cookie('mammyclub_register_popup_hidden');
        $('.close').click(function() {
          $('.thank-you-box').fadeOut();
          <? if(!$registerPopupHidden): ?>
            $.cookie('mammyclub_register_popup_hidden', '1', { expires: 3000});
          <? endif; ?>
        });
      });
    </script>
