...
abstract class Base_Admin_Lang_Tree_Controller extends Base_Admin_Tree_Controller {
 ...
 /**
  ...
  protected function preProcessFields(&$entity) {
    $defLang = array_search(config_item('language'), config_item('languages'));
    ManagerHolder::get($this->managerName)->setLanguage($defLang);
  ...
  public function add_edit($entityId = null, $parentId = null) {
    ...
    if ($entityId) {
      ...
      ManagerHolder::get($this->entityName)->setLanguage(null);
      $entity = ManagerHolder::get($this->entityName)->getById($entityId);
      $defLang = array_search(config_item('language'), config_item('languages'));
      ManagerHolder::setLanguage($defLang);
      ManagerHolder::get($this->entityName)->setLanguage($defLang);
    }
