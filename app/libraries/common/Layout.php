...
class Layout {
  ...
  /** Whether layout can be changed. */
  protected $layoutCanBeChanged = TRUE;
  ...
  public function Layout($layout = null) {
    ...
    $this->obj->load->config('block_config', FALSE, TRUE);
    if ($layout) {
   ...
   * @param string $layout
   */
  public function setLayout($layout, $ignoreCanBeChanged = FALSE) {
    if ($this->layoutCanBeChanged || $ignoreCanBeChanged) {
      $this->layout = self::DEFAULT_PATH_LAYOUT . '/' . $layout;
    }
  }
  
  /**
   * Setter for path to ONE layout.
   * This means layout cannot be changed
   * @param string $layout
   */
  public function setOneLayout($layout) {
    $this->layout = self::DEFAULT_PATH_LAYOUT . '/' . $layout;
    $this->layoutCanBeChanged = FALSE;
  }
