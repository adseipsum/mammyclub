...
class Fileoperations {
   ...
   */
  public function get_file_info($file_path, $doTranslit = TRUE) {
    $this->reset_file_info();
    $correct_file_name = iconv("cp1251", "utf-8", basename($file_path));
    if($doTranslit) {
      $correct_file_name = to_translit($correct_file_name);
    }
