...
class GeoCode {
  ...
  private $options = array(
		'url' => 'http://maps.googleapis.com/maps/api/geocode/',     // The URL to the API. WITH A TRAILING /
  	'responce_type' => 'json',     // Responce type (json, xml)  
    'region' => '',     // Region (http://en.wikipedia.org/wiki/CcTLD)   				 
		'language' => '', 	// Lanuage of results (http://spreadsheets.google.com/pub?key=p9pdwsai2hDMsLkXsoM05KQ&gid=1)	
		'sensor' => 'false', // Whether the request is from a device with a GPS sensor. Always FALSE	
	  'allowed_responce_location_types' => '', // Empty for all. ARRAY. http://code.google.com/apis/maps/documentation/geocoding/#Types
    'find_one' => TRUE // Whether to return ONE result or an array
  );
